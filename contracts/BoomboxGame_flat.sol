...
// =============================================================================
// BoomboxGame — flattened for BaseScan verification (Base Mainnet)
// Contract to verify: BoomboxGame
// Address: 0xc45D9d59842128eFb32E2644a227431c62d0919A
//
// Includes: IERC20 + BoomboxToken + BoomboxGame (no external imports).
// No OpenZeppelin dependencies.
// Compiler: Solidity 0.8.20+, Optimization enabled (200 runs recommended)
// Constructor arguments (ABI-encoded address):
//   0x63bBE8362b4e25D51AD0A86c7e45d3B2779E5f6C  (BoomboxToken)
// =============================================================================
